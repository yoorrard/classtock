...
const TeacherDashboard: React.FC<TeacherDashboardProps> = ({ onBack, classes, onCreateClass, onSelectClass, onDeleteClass, onNavigate, addToast, currentTeacherEmail, onWithdraw }) => {
    ...
    return (
        <>
            <LandingHeader
                context="teacher"
                onGoHome={() => onNavigate('teacher_dashboard')}
            ...
            <div className="container">
                <header className="header" style={{ marginBottom: '2rem', textAlign: 'left' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
                        <div>
                            <h1 style={{ fontSize: '1.8rem', margin: 0, color: '#0B6623', background: 'none', WebkitBackgroundClip: 'initial', WebkitTextFillColor: 'initial', alignItems: 'flex-start' }}>교사 대시보드</h1>
