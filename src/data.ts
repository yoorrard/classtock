...
4. 회사는 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여는 책임을 지지 않습니다.
...
가. 교사 회원
- 수집 항목: 이메일 주소, 비밀번호, (소셜 로그인 시) 소셜 계정 정보
- 이용 목적: 회원 식별, 학급 관리 기능 제공, 공지사항 전달, 민원 처리

나. 학생 회원
- 수집 항목: 이메일 주소, 비밀번호, 아이디(닉네임), (소셜 로그인 시) 소셜 계정 정보
...
- 회사는 원칙적으로 회원 탈퇴 시 지체 없이 해당 회원의 개인정보를 파기합니다. 단, 관계 법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 관계 법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
